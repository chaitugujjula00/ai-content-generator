...
const Header = () => {
  return (
    <div className='p-5 shadow-sm border-b border-b-secondary flex justify-between bg-[#090909]'>
        <div className='flex gap-2 items-center p-2 border rounded-md w-96 '>
            <Search/>
            <input type='text' placeholder='Search...' className='bg-[#090909] w-80 outline-none'/>
        </div>
